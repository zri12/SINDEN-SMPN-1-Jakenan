...
export function TeacherTable({ teachers, onView, onEdit, onDelete, onResetPassword }: TeacherTableProps) {
  const columns: TableColumn<Teacher>[] = [
    { key: "no", header: "No", render: (_teacher, index) => index + 1 },
    ...
    { key: "status", header: "Status Akun", render: (teacher) => <Badge status={teacher.status} /> },
    {
      key: "actions",
      header: "Aksi",
      render: (teacher) => (
