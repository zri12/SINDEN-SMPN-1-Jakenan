...
-- Fix:
-- 1. Login page bisa membaca settings/logo sebelum user login.
-- 2. Menghapus recursion RLS antar students, teachers, teacher_classes, assignments, submissions, grades.
